...
const HomePage = () => (
  <>
    ...
    <p>
      ...
      Azure Fundamental, Node.js, ReactJS, and I've started diving into lambda
      functions on AWS and RESTful APIs. I am enthusiastically open to learn new
      programming languages, frameworks, and libraries and work on positions
      that get me involved in any creative and technical areas.
    </p>
    <Footer />
  </>
);
